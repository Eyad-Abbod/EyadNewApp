...
class StopedUsers extends StatefulWidget {
  const StopedUsers({super.key});

  @override
  State<StopedUsers> createState() => _UsersState();
}

class _UsersState extends State<StopedUsers> {
  ...
  Future fetchs({String? query}) async {
    ...
    try {
      var response =
          await http.get(Uri.parse('$linkSearchAndChangeUser?state=0'));
    ...
    if (response['status'] == 'success') {
      if (mounted) {
        await AwesomeDialog(
          ...
          title: 'نجاح',
          desc: 'تمت عملية رفع الحظر بنجاح',
          btnOkOnPress: () {},
          btnOkColor: Colors.blue,
          btnOkText: 'خروج',
        ).show();
                              ...
                              itemBuilder: ((context, index) => Padding(
                                    ...
                                    child: InkWell(
                                      onTap: () => AwesomeDialog(
                                        ...
                                        // dialogColor: AppTheme.appTheme.primaryColor,
                                        title: 'رفع الحظر',
                                        desc: 'هل تريد رفع الحظر عن المستخدم',
                                        btnOkOnPress: () =>
